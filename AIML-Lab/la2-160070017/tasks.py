...
def taskSquare(draw):
	...
	nn1 = nn.NeuralNetwork(2,0.8,1,10)
...
def taskMnist():
	...
	nn1 = nn.NeuralNetwork(10,0.1,16,10)
...
def taskCifar10():	
	...
	nn1.addLayer(ConvolutionLayer([3,32,32], [10,10], 16, 2))
	nn1.addLayer(AvgPoolingLayer([16,12,12], [4,4], 4))
